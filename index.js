  ...
  async (
    ...
    */
    ...
    if (
      ...
      if (
        !xenditReferenceSnapshot.empty
      ) {
        return (
          xenditReferenceSnapshot.docs[0]
        );
      }
        ...
        for (
          ...
          */
          ...
          if (
            ...
            throw new Error(
              `Product ${product.name || productId} is archived.`
            );
          }
          ...
          */
          ...
          if (
            ...
            throw new Error(
              `Invalid price for ${product.name || productId}.`
            );
          }
          ...
          */
          ...
          if (
            ...
            throw new StockFulfillmentError(
              `Insufficient stock for ${product.name || productId}. Available: ${currentBatch.stock}, Requested: ${quantity}.`
            );
          }
        ...
        */
        ...
        for (
          ...
          */
          ...
          /*
            Same current-batch rule
            as your productService.ts.
          */
          ...
          if (
            ...
            throw new StockFulfillmentError(
              `No current batch found for ${orderProduct.name || productId}.`
            );
          }
          ...
          if (
            ...
            throw new StockFulfillmentError(
              `${orderProduct.name || productId} is out of stock.`
            );
          }
          ...
          if (
            ...
            throw new StockFulfillmentError(
              `Insufficient stock for ${orderProduct.name || productId}. Available: ${currentStock}, Requested: ${quantity}.`
            );
          }
          ...
          */
          ...
          /*
            Legacy fallback:
            if there are not enough harvest
            records to explain the whole stock,
            preserve the behavior of your
            existing recordSale().
          */
  ...
  async (
    ...
    try {
      ...
      */
      ...
      /*
        If a payment request already exists,
        try to reuse it.
      */
      ...
      /*
        ...
        The amount comes from Firestore,
        not from the Expo app.
      */
      ...
      */
      ...
      /*
        Current Xendit Payment Request API
      */
      ...
      const payload = {
        ...
        description:
          `FarmGate Order ${validated.orderNumber || orderId}`,
    ...
    try {
      ...
      */
      ...
      if (
        ...
        /*
          Do not change an already-paid order
          to failed.
        */
      ...
      /*
        =====================================================
        ONLY payment.capture FULFILLS THE ORDER
        =====================================================
      */
      ...
      */
      ...
      /*
        ...
        but order cannot be automatically
        fulfilled.
      */
